...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartTableMobileApi.ItemStateInfo();
  });
  ...
  describe('ItemStateInfo', function() {
    it('should create an instance of ItemStateInfo', function() {
      // uncomment below and update the code to test ItemStateInfo
      //var instance = new SmartTableMobileApi.ItemStateInfo();
      //expect(instance).to.be.a(SmartTableMobileApi.ItemStateInfo);
    });
