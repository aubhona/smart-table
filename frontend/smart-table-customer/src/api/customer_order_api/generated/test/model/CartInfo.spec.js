...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartTableMobileApi.CartInfo();
  });
  ...
  describe('CartInfo', function() {
    it('should create an instance of CartInfo', function() {
      // uncomment below and update the code to test CartInfo
      //var instance = new SmartTableMobileApi.CartInfo();
      //expect(instance).to.be.a(SmartTableMobileApi.CartInfo);
    });
