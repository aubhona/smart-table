...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartTableMobileApi.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new SmartTableMobileApi.ErrorResponse();
      //expect(instance).to.be.a(SmartTableMobileApi.ErrorResponse);
    });
