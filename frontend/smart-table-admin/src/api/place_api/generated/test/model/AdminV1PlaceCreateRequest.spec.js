...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartTableMobileApi.AdminV1PlaceCreateRequest();
  });
  ...
  describe('AdminV1PlaceCreateRequest', function() {
    it('should create an instance of AdminV1PlaceCreateRequest', function() {
      // uncomment below and update the code to test AdminV1PlaceCreateRequest
      //var instance = new SmartTableMobileApi.AdminV1PlaceCreateRequest();
      //expect(instance).to.be.a(SmartTableMobileApi.AdminV1PlaceCreateRequest);
    });
