...
import (
	...
	domain_errors "github.com/es-debug/backend-academy-2024-go-template/src/domains/admin/domain/errors"
...
func (o *UserRepository) CheckLoginOrTgLoginExist(ctx context.Context, login string, tg_login string) (bool, error) {
	queries := db.New(o.coonPool)
